...
/**
 * Apocalisse races.
 * In Apocalisse, each Origin is a standalone race (not a subrace).
 * The six Origins represent different backgrounds of the Last Ones
 * who survived or were reborn after the Apocalypse.
 */
export const apocalisseRaces: readonly Race[] = [
  // --- Figlio del Vecchio Mondo ---
  {
    ...
    languages: ['Babel Tongue', 'Old World Tongue'],
    subraces: [],
  },
  // --- Figlio dell'Apocalisse ---
  {
    id: 'child-apocalypse',
  ...
  // --- Risorto dall'Inferno ---
  {
    ...
    languages: ['Babel Tongue', 'Infernal'],
    subraces: [],
  },
  // --- Risorto dal Paradiso ---
  {
    id: 'risen-heaven',
    ...
    languages: ['Babel Tongue', 'Celestial'],
    subraces: [],
  },
  // --- Risorto dal Purgatorio ---
  {
    id: 'risen-purgatory',
